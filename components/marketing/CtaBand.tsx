...
const WEEK = [
  { d: "Day 1", dBn: "১ম দিন", t: "Your page is connected and answering in Bangla.", tBn: "আপনার পেজ কানেক্ট, বাংলায় উত্তর দেওয়া শুরু।" },
  { d: "Day 2", dBn: "২য় দিন", t: "Your catalog is synced; photo matching switches on.", tBn: "ক্যাটালগ সিঙ্ক হয়ে গেছে, ছবি মেলানো চালু।" },
  { d: "Day 4", dBn: "৪র্থ দিন", t: "First orders confirmed and booked with the courier.", tBn: "প্রথম অর্ডার কনফার্ম, কুরিয়ারও বুক।" },
  { d: "Day 7", dBn: "৭ম দিন", t: "You see exactly what it closed — and what it cost.", tBn: "কত অর্ডার হলো আর কত খরচ হলো, সব দেখতে পাবেন।" },
];
            ...
            <div className="p-8 lg:p-12">
              <Reveal>
                ...
                <ul className="mt-6 flex flex-wrap gap-x-5 gap-y-2">
                  {POINTS.map((p) => (
                    <li key={p.en} className="flex items-center gap-1.5 text-[13.5px] text-text-3">
                ...
                <div className="mt-8 flex flex-wrap items-center gap-3">
                  ...
                  <Magnetic strength={0.18}>
                    <Button href="/story" size="lg" variant="outline">
            ...
            <div className="relative border-t border-line bg-[#f2faf6] p-8 lg:border-l lg:border-t-0 lg:p-12">
              <Reveal delay={0.1}>
                <p className="font-display text-[15px] font-semibold tracking-tight text-text">
                  {t("What happens in the first week", "প্রথম সপ্তাহে যা যা হবে")}
                </p>
                <ol className="mt-5 space-y-5">
                  {WEEK.map((w) => (
                    <li key={w.d} className="flex gap-3.5">
                      ...
                      <span className="text-[14px] leading-snug text-text-2">{t(w.t, w.tBn)}</span>
                    </li>
                  ))}
                </ol>
              </Reveal>
