          ...
          <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
            <Reveal>
              ...
              <p className="mt-6 max-w-xl text-[16px] leading-relaxed text-text-2">
                Conversations are our cost, not your value. Every other tool in
                this category bills you for the two hundred people who asked
                &ldquo;দাম কত?&rdquo; and vanished. We don&apos;t.
              </p>
            </Reveal>
          </div>
        </section>
                  ...
                  <tbody>
                    {COMPARE.map(([label, a, b, c]) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5 text-[13.5px] font-medium text-text">
                          {a}
                        </td>
                        <td className="px-5 py-3.5 text-[13.5px] text-text-3">
                          {b}
                        </td>
                        <td className="px-5 py-3.5 text-[13.5px] text-text-3">
                          {c}
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)] lg:gap-16">
              <Reveal>
                ...
                <p className="mt-4 text-[14px] leading-relaxed text-text-3">
                  Something not covered here? Write to us — a person replies,
