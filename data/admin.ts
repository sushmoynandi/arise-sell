...
export const INITIAL_ADMIN_PLANS: AdminPlan[] = [
  {
    ...
    name: "Starter",
    nameBn: "স্টার্টার",
    tagline: "For emerging boutiques & solo Facebook shops",
    priceBDT: 2999,
    ...
    courierChannels: 1,
    features: [
      "2,500 automated customer conversations",
      "100 catalog products indexed",
      "WhatsApp or Messenger connected",
      "Steadfast Courier 1-click booking",
      "Bangla & Banglish NLU",
    ],
    activeMerchants: 28,
    status: "active",
  },
  {
    ...
    name: "Growth",
    nameBn: "গ্রোথ",
    tagline: "For scaling multi-channel eCommerce brands",
    priceBDT: 5999,
    billingPeriod: "monthly",
    messageLimit: 8000,
    catalogLimit: 500,
    ...
    badge: "Most Popular",
    features: [
      "8,000 automated customer conversations",
      "500 catalog products indexed",
      "WhatsApp + Messenger + Instagram Direct",
      "Steadfast & Pathao Courier Auto-Routing",
      "Customer Photo Vector Search (Vision AI)",
      "COD address verification bot",
    ],
    activeMerchants: 52,
    status: "active",
  },
  {
    ...
    name: "Scale",
    nameBn: "স্কেল",
    tagline: "High-volume commerce with zero human delay",
    priceBDT: 9999,
    billingPeriod: "monthly",
    messageLimit: 25000,
    catalogLimit: 2000,
    ...
    badge: "High Volume",
    features: [
      "25,000 automated customer conversations",
      "2,000 catalog products indexed",
      "All channels + Web storefront widget",
      "Multi-courier smart routing & failover",
      "Dedicated high-speed AI fallback pool",
      "Automated bKash/Nagad invoice verification",
    ],
    activeMerchants: 26,
    status: "active",
  },
  {
    id: "plan-eid-promo",
    name: "Eid Shopping Blitz (Special Offer)",
    nameBn: "ঈদ ব্লিটজ প্রমো",
    tagline: "Limited-edition high-burst seasonal tier",
    priceBDT: 7499,
    billingPeriod: "monthly",
    messageLimit: 15000,
    catalogLimit: 1000,
    courierChannels: 3,
    badge: "Limited Seasonal Tier",
    features: [
      "15,000 peak Eid conversation burst allowance",
      "1,000 products indexed",
      "Priority WhatsApp Cloud API queue",
      "Express Pathao same-day courier bridge",
    ],
    activeMerchants: 6,
    status: "active",
  },
